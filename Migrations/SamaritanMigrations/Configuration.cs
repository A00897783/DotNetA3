namespace a2.Migrations.SamaritanMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<a2.Models.SamaritanContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"Migrations\SamaritanMigrations";
        }

        protected override void Seed(a2.Models.SamaritanContext context)
        {
